...
export class VendorService {
 ...
 getVendorProfile(vendorId: string): Observable<VendorProfile> {
  ...
  getRFQList(): Observable<RFQ[]> {
    // Mock data - in real implementation: GET /RFQSet
    const mockRFQs: RFQ[] = [
      {
        rfqNo: 'RFQ001',
        material: 'MAT001',
  ...
  getPOList(): Observable<PurchaseOrder[]> {
    // Mock data - in real implementation: GET /POSet
  ...
  getGRList(): Observable<GoodsReceipt[]> {
    // Mock data - in real implementation: GET /GRSet
  ...
  getInvoices(): Observable<Invoice[]> {
    // Mock data - in real implementation: GET /InvoiceSet
  ...
  getPayments(): Observable<Payment[]> {
    // Mock data - in real implementation: GET /PaymentSet
  ...
  getMemos(): Observable<Memo[]> {
    // Mock data - in real implementation: GET /MemoSet
